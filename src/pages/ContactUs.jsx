    ...
    <div className="max-w-4xl mx-auto px-4 py-10 text-center space-y-10">
      ...
      <section>
        ...
        <div className="mt-6 text-base font-medium">
          <p>
            ...
            <span className="text-fuchsia-700">09:00 am – 06:00 pm</span>
          </p>
          <p>
            <span className="font-semibold">Fri - Sat:</span>{" "}
            <span className="text-fuchsia-700">Closed</span>
          </p>
        </div>
      ...
      <section className="text-sm text-gray-700 cursor-pointer">
        <div
          ...
          className="font-bold text-black transition hover:underline inline-flex items-center justify-center gap-2"
        >
          {currentDay}{" "}
          <span className="text-fuchsia-700">{hours[currentDay]}</span>
          <svg
